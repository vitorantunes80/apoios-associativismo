...
var Relatorios = (function() {
  ...
  function _repHorasIndividual(funcId) {
    ...
    h += '<thead><tr><th>Data</th><th>Tipo</th><th>Horas</th><th>Justificação</th><th>Equipamento</th><th>Saldo acum.</th></tr></thead><tbody>';
    ...
    movs.forEach(function(r) {
      ...
      h += '<td>' + (gozada ? 'Gozar horas' : 'Horas extra') + '</td>';
