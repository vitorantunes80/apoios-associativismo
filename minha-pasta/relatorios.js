...
var Relatorios = (function() {
  ...
  function _repEqMensal(eq) {
    ...
    if (modAtivo(eq, 'reservas') && d.reservasL && d.reservasL.length) {
      ...
      h += '<table class="pr-table"><thead><tr><th>Data</th><th>Horário</th><th>Título</th><th>Entidade</th><th>Estado</th></tr></thead><tbody>';
      listaRes.forEach(function(r) {
        ...
        if (r.recorrente) {
          hor = 'Recorrente';
        } else if (r.data_inicio && r.data_fim) {
          hor = String(r.data_inicio).slice(11, 16) + '–' + String(r.data_fim).slice(11, 16);
