...
var Dashboard = (function() {
  ...
  function render() {
    ...
    if (APP.isDds()) {
      ...
      html += _statCard('si-green',  _svgTeam(), 'Funcionários',   APP.utilizadores.filter(function(u){return !u.isDds;}).length, 'Registados', APP.podeGerirUtilizadores()?"App.nav('funcionarios')":'');
      ...
      html += _statCard('si-purple', _svgCal(),  'Reservas Hoje',   reservasHoje,   'No equipamento', "App.nav('reservas')");
      html += _statCard('si-teal',   _svgCal(),  'Reservas Semana', reservasSemana, 'Total da semana', "App.nav('reservas')");
  ...
  function _renderReparacoesTab(eqId) {
    ...
    // stats rápidas
    html += '<div class="stats-grid" style="grid-template-columns:repeat(3,1fr);margin-bottom:14px;">';
