...
var Dashboard = (function() {
  ...
  function _renderEscala() {
    ...
    var LINHA = 26;   // altura de uma hora, em px
    ...
    hours.forEach(function(h, hi) {
      ...
      dias.forEach(function(d) {
        ...
        escalas.forEach(function(e) {
          ...
          html += '<div class="sched-event" title="' + H(nome) + ' · ' + hrs + '" style="background:' + cc.bg + ';color:' + cc.color + ';top:' + (offset + 1) + 'px;height:' + altura + 'px;cursor:pointer;" onclick="App.nav(\'escalas\')">';
          html += H(nome);
          html += '<br><span style="font-weight:400;opacity:.75;font-size:9.5px;">' + hrs + (sub ? ' · ' + H(sub) : '') + '</span>';
          html += '</div>';
        });
        html += '</div>';
      });
