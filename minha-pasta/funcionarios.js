...
var Funcionarios = (function() {
  ...
  function _tabela(funcs, isAdmin) {
    ...
    funcs.forEach(function(u) {
      ...
      else if (u.username) html += '<div class="td-m">' + H(u.username) + '</div>';
      html += '</div></div></td>';
  ...
  function getModaisHTML() {
    ...
    html += '<div class="fi"><label class="fl">Username</label><input type="text" id="func-username" class="fin" placeholder="ex: ana.silva"></div>';
    html += '</div>';
    ...
    html += '<select id="func-area" class="fin">';
    html += '<option value="">Nenhuma</option>';
    html += '<option value="Ação Social">Ação Social</option>';
    html += '<option value="Saúde">Saúde</option>';
    html += '<option value="Educação">Educação</option>';
    html += '<option value="Desporto">Desporto</option>';
    html += '<option value="Associativismo">Associativismo</option>';
    html += '<option value="Juventude">Juventude</option>';
    html += '</select></div>';
    html += '</div>';
    html += '<div class="form-row">';
    html += '<div class="fi"><label class="fl">Função</label><input type="text" id="func-funcao" class="fin" placeholder="ex: Coordenador de instalações"></div>';
    html += '<div class="fi"><label class="fl">Categoria</label>';
    html += '<select id="func-categoria" class="fin">';
    html += '<option value="">Nenhuma</option>';
    html += '<option value="Assistente Operacional">Assistente Operacional</option>';
    html += '<option value="Assistente Técnico">Assistente Técnico</option>';
    html += '<option value="Técnico Superior">Técnico Superior</option>';
    html += '</select></div>';
    html += '</div>';
  ...
  function openNovo() {
    ...
    ['func-nome','func-codigo','func-email','func-username','func-funcao'].forEach(function(id) {
  ...
  function salvar() {
    ...
    var body = {
      ...
      username:       (document.getElementById('func-username').value || '').trim(),
      perfil:         pSel ? pSel.value : 'funcionario',
      isDds:          false,
